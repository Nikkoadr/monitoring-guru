                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Form Tambah Kepala Sekolah</h3>
                            </div>
                            <div class="card-body">
                                <form action="/post_kepsek" method="post">
                                    @csrf
                                    <label for="kepsek">Nama Kepala Sekolah:</label>
                                    <input class="form-control" type="text" id="kepsek" name="kepsek" autocomplete="off">
                                    ...
                                    <a href="/data_kepsek" class="btn btn-danger mt-2 float-right mr-2">Batal</a>
                                </form>
                            </div>
                        </div>
                    </div>
...
<script>
    document.getElementById('kepsek').addEventListener('input', function () {
                ...
                .then(data => {
                    ...
                    data.forEach(user => {
                        ...
                        suggestion.addEventListener('click', function () {
                            document.getElementById('kepsek').value = user.name;
