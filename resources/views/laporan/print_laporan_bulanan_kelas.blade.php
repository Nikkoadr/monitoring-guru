    ...
    <div class="page-landscape">
        ...
        <table style="border: 1px solid black; border-collapse: collapse; width: 100%;">
                ...
                <tr>
                    ...
                    @endphp
                    <th colspan="{{ $start->diffInDays($end) + 1 }}" style="border: 1px solid black; padding: 5px;">Tanggal</th>
                ...
                <tr>
                    ...
                    <th style="border: 1px solid black; padding: 5px; text-align: center;">Tidak Masuk</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($rekap as $data)
                    <tr>
                        <td style="border: 1px solid black; padding: 5px; text-align: center;">{{ $data->nama_siswa }}</td>
                        <td style="border: 1px solid black; padding: 5px; text-align: center;">{{ $data->nama_kelas }}</td>
                        @php
                            $start = \Carbon\Carbon::parse($tanggalAwal);
                            $end = \Carbon\Carbon::parse($tanggalAkhir);
                        @endphp
                        ...
                        <td style="border: 1px solid black; padding: 5px; text-align: center;">{{ $data->total_tidak_diketahui }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
