        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <img src="{{ asset('assets/dist/img/logo.png') }}" alt="smkmu Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <nav class="mt-2">
                ...
                <li class="nav-item">
                    <a href="/data_presensi_pendidik" class="nav-link {{ request()->is('data_presensi_pendidik') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="/request_izin_pendidik" class="nav-link {{ request()->is('request_izin_pendidik') ? 'active' : '' }}">
