                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/admin_post_presensi_pendidik" method="post" enctype="multipart/form-data">
                                    ...
                                    <input class="form-control" type="text" id="pendidik" name="pendidik" autocomplete="off" required>
                                    ...
                                    <input class="form-control" type="time" id="jam_masuk" name="jam_masuk">

                                    <label for="jam_keluar">Jam Keluar:</label>
                                    <input class="form-control" type="time" id="jam_keluar" name="jam_keluar">

                                <div class="form-group">
                                    <label for="foto_masuk">Foto Bukti:</label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="foto_masuk" name="foto_masuk" accept="image/*">
                                        <label class="custom-file-label" for="file">Pilih File</label>
                                    </div>
                                </div>

                                    <label for="id_status_hadir">Status Kehadiran:</label>
                                    <select class="form-control" name="id_status_hadir" id="id_status_hadir" required>
