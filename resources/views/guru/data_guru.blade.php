                                ...
                                <table id="table_guru" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-danger float-right m-1" onclick="confirmDelete({{ $guru->id }})"><i class="fa-solid fa-trash-can"></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
}).buttons().container().appendTo('#table_guru_wrapper .col-md-6:eq(0)');
});
</script>
